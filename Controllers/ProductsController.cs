...
namespace ConstruccionDeSoftware_ProyectoFinal.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var products = db.Products.Include(p => p.List);
        ...
        public ActionResult Create([Bind(Include = "ProductID,ListID,Name,Quantity")] Product product)
        {
            ...
            ViewBag.ListID = new SelectList(db.Lists, "ListID", "Name", product.ListID);
            return View(product);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,ListID,Name,Quantity")] Product product)
        {
            if (ModelState.IsValid)
            {
